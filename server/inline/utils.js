...
const KEY = '新鲜天气'   //和风天气中应用的key名称
const USER_ID = 'HE1904131554031008' //和风天气中应用的密钥ID

const WECHAT_APPID = 'wx4c4ad04368ab2650'
const WECHAT_APP_SECRET = '910a559d782507f97689f360b0689b72'
const $ = {
  getWechatAppConfig: () => {
    return {
      id: WECHAT_APPID,
 ...
 */
  ...
  handlerData: (data) => {
    console.log('he-weather-data:',data)
